...
namespace Auto_Login
{
    ...
    {
        public static int FindWebsite(string name,  ObservableCollection<Website> websites)
        {
            return websites.IndexOf(websites.Where<Website>(x => x.WebsiteName == name) as Website);
        }
